...
public class Person {
    ...
    public String getFirstName() {// first method
        return this.firstName;
    }

    public String getLastName() {//second method
        return this.lastName;
    }

    public int getAge() {//third method
        return this.age;
    }

    public void setFirstName(String firstName) {//forth method
        this.firstName = firstName;
    }

    public void setLastName(String lastName) {//fifth method
        this.lastName = lastName;
    }

    public void setAge(int age) {//sixth method
        if (age < 0 || age > 100) {
            this.age = 0;
    ...
    public boolean teen() {//seventh method
    ...
    public String getFullName() {//eighth method
