 ...
 */
public class Wall {//class name
    double width;
    double height;

    public Wall() {//constructor 1
    }

    public Wall(double width, double height) {//constructor 2
        this.width = width;
        this.height = height;
    ...
    public double getWidth() {// return type getWidth without any parameters 1
        return width;
    }

    public double getHeight() {// return type getHeight without any parameters 2
        return height;
    }

    public double setWidth(double width) {//return type with parameter double width 3
        if (width < 0) {
            this.width = 0;
        } else {
            this.width = width;
        ...
        public double setHeight(double height){//return type with parameter double height 4
            if (height < 0) {
                this.height = 0;
            } else {
                this.height = height;
        ...
        public double getArea() {//return type without any parameter 5
